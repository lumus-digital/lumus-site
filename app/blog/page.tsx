...
export function BlogPageView({ articles, category }: BlogPageViewProps) {
  ...
  return (
    <section className="mx-auto flex w-full max-w-5xl flex-col p-8 mt-12 mb-12">
      <Breadcrumb
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {filteredArticles.map((article) => (
          <Link
            ...
            className="group block h-full max-w-xl rounded-xl ring-1 ring-transparent shadow-lg transition duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:ring-purple-500/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
            aria-label={`Abrir artigo ${article.title}`}
          >
            <article className="flex h-full flex-col items-start justify-between rounded-xl">
              {article.image && (
              ...
              <div className="flex items-center gap-x-4 text-xs mb-2">
                ...
                <span
                  className="rounded-full bg-purple-600/80 px-3 py-1.5 font-medium text-white shadow-sm"

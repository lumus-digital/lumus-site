...
export default function About() {
  return (
    <section className="flex flex-col md:flex-row gap-12 max-w-5xl w-full mx-auto p-8 mt-12 mb-12">
      ...
      <div className="flex-2 flex flex-col justify-center gap-4">
        ...
        <Text as="p" className="text-gray-400 text-lg">
          ...
          inovação e propósito. Inspirada por universos encantados e pelo estilo
          visual que representa minha personalidade, a marca foi criada para ser
          um espaço de inovação, acolhimento e soluções digitais.
        </Text>
        <Text as="p" className="text-gray-400 text-lg">
        ...
        <Text as="p" className="text-gray-400 text-lg mt-6">
          ...
          Vue.js e Next.js. Ao longo da minha trajetória, também atuei como Tech
          Lead, apoiando múltiplos times, estruturando processos e incentivando
          o crescimento técnico e pessoal de outras pessoas. Liderar, para mim,
          nunca foi sobre hierarquia - sempre foi sobre iluminar caminhos.
        </Text>
        <Text as="p" className="text-gray-400 text-lg">
          ...
          acessível e bem construída. Pode contar histórias. Pode gerar impacto
          real.
        </Text>
        <Text
          as="h2"
        ...
        <Text as="p" className="text-gray-400 text-lg mt-6">
          Este espaço é onde pretendo compartilhar aprendizados, reflexões sobre
          carreira, liderança técnica e desenvolvimento web. Te convido a
          acompanhar essa jornada, onde o objetivo é crescer, aprender e
